...
document_extensions = {".doc": "Word Documents",
                       ".docx": "Word Documents",
                       ".odt": "Word Documents",
                       ".pdf": "PDFs",
                       ".xls": "Excel Files",
...
programming_files_extensions = {".c": "C Source Files",
                                ".cpp": "C++ Source Files",
...
def segregate_files_by_extension(directory):
    ...
    for file in os.listdir(directory):
        ...
        if os.path.isfile(file_path):
            ...
            files_found = True  # Set flag to True if files are found

            # Create directory for the file type
            if extension in image_extensions and check_type[0] == 1:
...
# we can either run this file or use the interface file to make it simple
